...
2. Client encrypts the private key using AES/GCM/NoPadding as cipher (256 bit key size) and uses PBKDF2WithHmacSHA256 as key derivation with 600000 iterations, as password the in step 1 generated mnemonic is used. 
