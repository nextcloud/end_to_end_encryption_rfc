...
2. Client uploads the X.509 CSR to the server
  ...
  2. The client transmits the CSR as URL encoded `POST` parameter `csr` to the `/public-key` OCS API endpoint.
